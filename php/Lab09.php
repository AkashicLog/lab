...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              global $countries;
              ksort($countries);
              foreach ($countries as $X_value){
                  $a_element ="<a href='list.php?country=";
                  $a_element .=$X_value;
                  $a_element .="' role='button' class='btn btn-default'>";
                  $a_element .=$X_value;
                  $a_element .="</a>";
                  echo $a_element;
              }
   ...
   //              </a>
          ...
          foreach ($images as$X=>$X_value){
              $li_element ="<li><a herf='detail.php?id=";
              $li_element .=$X_value["id"];
              $li_element .="' class='imf-responsive'><img src='../images/square/";
              $li_element .=$X_value["path"];
              $li_element .="'alt='";
              $li_element .=$X_value["title"];
              $li_element .="'><div class='caption'><div class='blur'></div><div class='caption-text'><h1>";
              $li_element .=$X_value["title"];
              $li_element .="</h1></div></div></a></li>";
              echo  $li_element;
          }
          ?>
